...
let e = String(err)
hyuuxyz.sendMessage("628985397156@s.whatsapp.net", { text: "Hello developer, terdapat fitur error " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
